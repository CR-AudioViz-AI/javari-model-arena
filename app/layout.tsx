...
export const metadata: Metadata = { title: 'Javari Model Arena', description: 'Compare 300+ AI models side by side', openGraph: { title: 'Javari Model Arena', description: 'Compare 300+ AI models side by side', type: 'website' } }
      ...
      <body style={{ margin: 0, padding: 0, background: '#0a0a0f' }}>
        <div style={{ background: 'rgba(0,0,0,0.85)', height: 60, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 20px', position: 'fixed', top: 0, left: 0, right: 0, zIndex: 100 }}>
          <a href="https://craudiovizai.com" style={{ color: '#fff', textDecoration: 'none', fontWeight: 700, fontSize: 14 }}>
            <span>🤖</span> <span style={{ color: '#8b5cf6' }}>Javari Model Arena</span> <span style={{ color: '#374151', fontSize: 11 }}>· CR AudioViz AI · EIN 39-3646201</span>
          </a>
